...
public class DocumentWorkflowController extends  AbstractWorkflowController {
    ...
    public String getRedirectUrl(HttpServletRequest request) {
        return "document?documentId=" + getDocumentId(request);
    }

    private long getDocumentId(HttpServletRequest request) {
        return Long.parseLong(request.getParameter("documentId"));
    }
    ...
    public Map getArgs(HttpServletRequest request) {
        ...
        args.put("documentId", new Long(getDocumentId(request)));
        return args;
    }
